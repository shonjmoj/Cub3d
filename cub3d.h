...
/*   Updated: 2022/12/28 12:05:05 by elounejj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_vertical_calc(t_data data, \
		t_vector *step_v, t_vector *a_v);
int			ft_check_vertical(t_data data, \
		t_vector	*step_v, t_vector *a_v, int *v);
int			ft_check_horizontal(t_data data, \
		t_vector *step_h, t_vector *a_h, int *h);
